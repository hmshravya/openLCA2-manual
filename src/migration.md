...
With version 2.7.0, openLCA provides a powerful data migration tool. Henceforth, LCA models can be migrated from one database to another by linking them to the corresponding background data in the target database. 

Use cases for such a migration tool are:
